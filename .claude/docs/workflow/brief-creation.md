...
| Skip .claude/context/philosophy.md | Brief drifts from mission | Always read .claude/context/philosophy.md, check alignment |
...
**AI**: Reads .claude/context/philosophy.md → "What architectural questions remain?"
