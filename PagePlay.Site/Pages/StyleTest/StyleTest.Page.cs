...
public class StyleTestPage(IHtmlRenderer _renderer) : IStyleTestPageView
{
    ...
    {
        var page = new Page(
            new PageTitle("Style Test"),

            // Interactive Button Test - button and result in same card
            new Section(
                new SectionTitle("Interactive Test"),
                new Card()
                    .Header(new Text("Random Number Generator"))
                    .Body(
                        new Stack(For.Fields,
                            ...
                            new Section()
                                .Id("random-result")
                                .Children(
                                    new Text("Result will appear here.")
                                )
                        )
                    )
            ),
